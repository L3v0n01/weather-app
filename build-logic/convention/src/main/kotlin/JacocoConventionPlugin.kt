...
private val JACOCO_EXCLUSIONS = listOf(
    ...
    // Compose — generated bytecode not covered by unit tests
    "**/*Screen*.*", "**/*Kt\$*.*Composable*.*",
    "**/*ComposableSingletons*.*",
    "**/theme/**", "**/icon/**",
    // Data classes / enums — generated equals/hashCode/copy/toString/values
    "**/model/weather/CurrentWeather.*",
    "**/model/weather/HourlyForecast.*",
    "**/model/weather/DailyForecast.*",
    "**/model/weather/WeatherForecast.*",
    "**/model/location/City.*",
    "**/model/settings/TemperatureUnit.*",
    "**/model/settings/ThemeMode.*",
    "**/model/Resource*.*",
)
...
class JacocoConventionPlugin : Plugin<Project> {
    ...
    private fun JacocoReport.configureReport() {
        ...
        classDirectories.setFrom(
            project.fileTree(project.layout.buildDirectory.get().asFile) {
                include(
                    ...
                    "intermediates/classes/debug/**/dirs/**/*.class",
        ...
        reports {
            ...
            csv.outputLocation.set(project.layout.buildDirectory.file("reports/jacoco/jacoco.csv"))
        }
    }
}
